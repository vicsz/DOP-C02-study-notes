...
- [Adrian Cantrill Study Guide](https://learn.cantrill.io/p/aws-certified-devops-engineer-professional) -- paid guide / excellent -- best paid guide out there ~70hrs 
...
### White Papers & FAQs
- [AWS Introduction to DevOps](https://docs.aws.amazon.com/pdfs/whitepapers/latest/introduction-devops-aws/introduction-devops-aws.pdf) -- Solid overview / good intro to DOP-C02
- [AWS DevOps Guidance](https://docs.aws.amazon.com/wellarchitected/latest/devops-guidance/devops-guidance.pdf) -- not very technical -- but good leadership style doc on driving adoption (DevOps) . **Must read** White Paper in General for Driving DevOps Adoption.
- [Infrastructure as Code - AWS Whitepaper](https://d1.awsstatic.com/whitepapers/infrastructure-as-code.pdf) -- must read !
