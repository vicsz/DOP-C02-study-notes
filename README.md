...
- [AWS DevOps Guidance](https://docs.aws.amazon.com/wellarchitected/latest/devops-guidance/devops-guidance.pdf) -- not very technical -- but good leadership style doc on driving adoption (DevOps)
